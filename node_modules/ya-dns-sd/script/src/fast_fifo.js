...
exports.FastFIFO = exports.ERROR = exports.END = void 0;
exports.END = Symbol("Stream ended.");
exports.ERROR = Symbol("Stream errored.");
...
class FastFIFO {
    ...
    async *[Symbol.asyncIterator]() {
        while (true) {
            ...
            if (value === exports.END || value === exports.ERROR) {
                break;
            }
            yield value;
        }
