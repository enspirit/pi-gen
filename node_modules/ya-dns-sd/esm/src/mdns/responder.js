...
import { concat } from "../../deps/deno.land/std@0.177.0/bytes/concat.js";
import { encodeRdataA, encodeRdataAAAA, encodeRdataTXT, } from "../decode/message_encode.js";
import { DnsClass, isResourceRecordA, isResourceRecordAAAA, isResourceRecordNSEC, isResourceRecordPTR, isResourceRecordSRV, isResourceRecordTXT, ResourceType, } from "../decode/types.js";
...
family) {
    ...
    for (const question of questions) {
        for (const record of answers) {
             ...
             */
            const unknowableByUs = (question.QTYPE === ResourceType.AAAA && family === "IPv4") ||
...
export function recordSort(a, b) {
    if (a.CLASS < b.CLASS) {
        return -1;
    }
 ...
 */
export function isConflicting(a, b) {
