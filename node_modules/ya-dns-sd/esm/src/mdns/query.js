...
import { shallowEqualArrays } from "../../deps.js";
import { DnsClass, ResourceType, } from "../decode/types.js";
import { FastFIFO } from "../fast_fifo.js";
import { isConflicting, recordSort } from "./responder.js";
...
export class Query {
    ...
    getQuestions() {
        ...
        for (const question of this.questions) {
            ...
            if (question.recordType !== ResourceType.PTR &&
    ...
    addRecord(record) {
        ...
        if (record.isUnique) {
            for (const [prevRecord] of this.records) {
                if (shallowEqualArrays(record.NAME, prevRecord.NAME) &&
