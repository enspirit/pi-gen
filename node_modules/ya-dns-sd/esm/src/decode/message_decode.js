...
export function decodeHeader(message) {
...
export function decodeQuestion(message, 
...
export function decodeResourceRecord(message, 
/** The position of this question within its DNS message's bytes */
startPosition) {
    const dataView = new DataView(message.buffer);
    const { labels, nextPosition } = decodeLabels(message, startPosition);
...
export function decodeRdata(type, message, rdataPosition, rdataLength) {
    switch (type) {
        case ResourceType.A: {
            return [
