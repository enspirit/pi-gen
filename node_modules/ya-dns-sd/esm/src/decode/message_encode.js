import { isResourceRecordA, isResourceRecordAAAA, isResourceRecordNSEC, isResourceRecordPTR, isResourceRecordSRV, isResourceRecordTXT, } from "./types.js";
import { concat } from "../../deps/deno.land/std@0.177.0/bytes/mod.js";
...
export function encodeRdataA(resourceRecord) {
...
export function encodeRdataTXT(attributes) {
...
export function encodeRdataAAAA(ipv6Addr) {
