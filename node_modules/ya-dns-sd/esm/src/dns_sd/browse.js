import { isResourceRecordA, isResourceRecordAAAA, isResourceRecordPTR, isResourceRecordSRV, isResourceRecordTXT, ResourceType, } from "../decode/types.js";
import { FastFIFO } from "../fast_fifo.js";
import { Query } from "../mdns/query.js";
...
class ServiceResolver {
    ...
    async resolveSrv(record) {
        ...
        for await (const event of hostnameQuery) {
            switch (event.kind) {
                case "ADDED": {
                    if (isResourceRecordA(event.record) ||
